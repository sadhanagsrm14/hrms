      <div class="page-sidebar sidebar">
        ...
        <div class="page-sidebar-inner slimscroll">
              ...
              <!-- <a href="javascript:void(0);" id="profile-menu-link"> -->
                ...
                <a href="javascript:void(0);">
                 ...
                 <div class="sidebar-profile-image">
                  ...
                  <a href="<?php echo e(URL('/hrManager/dashboard')); ?>"><img src="<?php echo e(\Auth::user()->cb_profile->employee_pic); ?>" class="img-circle img-responsive" alt=""></a>
          ...
          <li class="droplink <?php echo e(setActive('hrManager/request/profile-update')); ?> <?php echo e(setActive('hrManager/leave-listing')); ?>"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-inbox"></span><p>Requests</p><span class="arrow"></span></a>
          ...
          <li class="droplink <?php echo e(setActive('/resign')); ?>">
            ...
            <ul class="sub-menu">
              ...
              <li><a href="<?php echo e(URL('/resign')); ?>">View Resignation</a></li>
             <?php }else  {?>
              <li><a href="<?php echo e(URL('/hrManager/retract')); ?>">View Retract</a></li>
            <?php } ?>
