			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(URL('/itExecutive/mac_mini/update')); ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset_type" id="asset_type" class="form-control select2"  required="required">
											...
											<option value="<?php echo e($asset_type->id); ?>" <?php echo e($asset_type->id == $asset->asset_type_id?"selected":""); ?>><?php echo e($asset_type->type); ?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset" id="asset" class="form-control select2"  required="required">
											...
											<?php $__currentLoopData = $asset_assocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset_assoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

											<option value="<?php echo e($asset_assoc->id); ?>" <?php echo e($asset_assoc->id == $asset->asset_id?"selected":""); ?>><?php echo e($asset_assoc->name); ?></option>
