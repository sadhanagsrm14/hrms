				...
				<div class="row">
					...
					<div class="col-md-3 center">
						...
						<div class="login-box">
							...
							<form class="m-t-md" action="<?php echo e(URL('/login')); ?>" method="post">
								...
								<a href="<?php echo e(URL('/forget-password')); ?>" class="display-block text-center m-t-md text-sm">Forgot Password?</a>
