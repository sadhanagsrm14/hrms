      <div class="page-sidebar sidebar">
              ...
              <!-- <a href="javascript:void(0);" id="profile-menu-link"> -->
                ...
                <a href="javascript:void(0);">
                 ...
                 <div class="sidebar-profile-image">
                  ...
                  <a href="<?php echo e(URL('/admin/dashboard')); ?>"><img src="http://hrms.codingbrains.com/images/employees/default-user.png" class="img-circle img-responsive" alt=""></a>
          ...
          <ul class="sub-menu">
            ...
            <li><a href="<?php echo e(URL('/admin/assets/all_assets')); ?>">Asset List</a></li>

            <li><a href="<?php echo e(URL('/admin/add-asset')); ?>">Create Asset</a></li>

            <li><a href="<?php echo e(URL('/admin/assets/all_system')); ?>">Systems</a></li>
      ...
      <?php echo e(setActive('admin/holiday-calender')); ?>

      <?php echo e(setActive('admin/retract-leave')); ?>"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-calendar"></span><p>Attendance / Leave</p><span class="arrow"></span></a>
      ...
      <ul class="sub-menu">
        ...
        <li><a href="<?php echo e(URL('/admin/leave-listing')); ?>">Leave Listing</a></li>
          <li><a href="<?php echo e(URL('/admin/retract-leave')); ?>">Retract Leave Listing</a></li>
    ...
    <li class="droplink <?php echo e(setActive('admin/eods')); ?> "><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-book"></span><p>EODs</p><span class="arrow"></span></a>
      ...
      <ul class="sub-menu">
        ...
        <li><a href="<?php echo e(route('admin.hreod')); ?>"> HR Eod List</a></li> 
    ...
    <li class="droplink <?php echo e(setActive('admin/resignations')); ?>  <?php echo e(setActive('admin/retract')); ?>"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-briefcase"></span><p>Resignations</p><span class="arrow"></span></a>

      <ul class="sub-menu">

        <li><a href="<?php echo e(URL('/admin/resignations')); ?>">Resignation List</a></li>
         <li><a href="<?php echo e(URL('/admin/retract')); ?>">Retract List</a></li>
      ...
      <li class="droplink <?php echo e(setActive('admin/request/profile-update')); ?>  <?php echo e(setActive('admin/leave-listing')); ?>"><a href="#" class="waves-effect waves-button"><span class="menu-icon fa fa-inbox"></span><p>Requests</p><span class="arrow"></span></a>
