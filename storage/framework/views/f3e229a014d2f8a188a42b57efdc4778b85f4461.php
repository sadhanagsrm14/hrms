												...
												<div class="col-md-12">
													<div class="row">
														...
														<div class="form-group col-md-6">
															...
															<input type="text" class="form-control" name="first_name" id="first_name" placeholder="First Name" value="<?php echo e(Request::old('first_name')); ?>">
														...
														<div class="form-group  col-md-6">
															...
															<span class="label label-danger"><?php echo e($errors->first('role')); ?></span>
															<?php endif; ?>
														</div>
