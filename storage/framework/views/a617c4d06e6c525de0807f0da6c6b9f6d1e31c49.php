	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><a href="<?php echo e(URL('/admin/attendance')); ?>">Attendance</a></li>
		...
		<div class="row">
				...
				<div class="panel panel-white">					
					...
					<div class="panel-body">
						...
						<div class="col-md-8">
							...
							<a  class="btn btn-success pull-right UpdateAttendance" style="margin-top: -16px;" data-mydate="<?php echo e(date('Y-m-d')); ?>" data-emptype="<?php echo e($type); ?>">Review Today's Attendance</a>
							...
							<a href="<?php echo e(URL('/admin/export/attendance-sheet')); ?>" class="btn btn-warning pull-right" style="margin-top: -16px;margin-right: 10px;">Export Attendance</a>
								...
								<tr>
									...
									<tr>									
										...
										<tr>
											...
											<td><a class="btn btn-reponsive btn-primary UpdateAttendance" data-mydate="<?php echo e($date); ?>" data-emptype="<?php echo e($type); ?>">Edit</a></td>
			...
			<div class="modal fade empList-modal-sm" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="modal-dialog">
					...
					<form class="modal-content" action="<?php echo e(URL('admin/submitAttendance')); ?>" id="assignAssetForm" method="post">

						<?php echo e(csrf_field()); ?>


						<input type="hidden" name="attendanceDate" id="attendanceDate" value="<?php echo e(date('Y-m-d')); ?>">
						<input type="hidden" name="emptype" id="emptype" value="<?php echo e($type); ?>">
						...
						<div class="modal-body">
							...
							<div class="panel panel-white">
								...
								<div class="panel-heading clearfix">
									...
									<h4 class="panel-title" id="msg123">Add Attendance for <?php echo e(date('Y-m-d')); ?></h4>	
			...
			$(document).ready(function(){
				...
				$('#uploadAttendance').on('click',function(){
					...
					if(attendanceFile.files[0]) {
						...
						var url  = "<?php echo e(URL('/admin/import/attendance-sheet')); ?>";
