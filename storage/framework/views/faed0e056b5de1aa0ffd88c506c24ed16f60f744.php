			...
			<div class="col-md-8">
				<div class="panel panel-white">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<?php echo e(URL('/admin/system/update')); ?>" method="post" enctype="multipart/form-data">
							<div class="box-body">
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><a class="btn btn-success" href="<?php echo e(URL('/admin/release-system-asset/'.$system_asset->system_id.'/'.$system_asset->id)); ?>">Release</a></td>
