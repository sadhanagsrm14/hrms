...
<?php $__env->startSection('title','Leave Retract'); ?>
						...
						<div class="table-responsive table-remove-padding">
                         <table class="table dataTable no-footer" id="datatable" role="grid" aria-describedby="datatable_info">
								...
								<tbody>
									...
									<?php $__currentLoopData = $leave_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $retract): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									<tr>
										...
										<td>
											...
											<?php if($retract->is_accept == 1): ?>
											<span class="text-success">Accepted</span>

											<?php elseif($retract->is_accept == 0): ?>
											<b class="text-warning">Pending</b>
											<?php elseif($retract->is_accept == -1): ?>
											<b class="text-danger">Rejected</b>
											<?php endif; ?>

										</td>

										<td><a href="javascript::void()" onclick="view(<?php echo e($retract->leave_id); ?>)" class="btn btn-primary"><i class="fa fa-eye"></i>View</a></td>
...
<script>
	...
	function view(id){
		...
		var resignUrlaccept = "<?php echo e(URL('/admin/retract_leave/accepted/')); ?>";
		var resignUrlaccept1 = (resignUrlaccept +'/' + id) ;
		var resignUrlrejected = "<?php echo e(URL('/admin/retract_leave/rejected/')); ?>";
		var resignUrlrejected1 = (resignUrlrejected +'/' + id) ;
		$('#acceptedid').attr("href",resignUrlaccept1 );
		$('#rejectedid').attr("href",resignUrlrejected1);
         var resignUrl = "<?php echo e(URL('/retract_leave1/')); ?>";
