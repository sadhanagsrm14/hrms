...
<div class="page-inner">
	...
	<div class="page-title">
		...
		<input type ="hidden"  id="system_id" value="<?php echo e($system->id); ?>">
			...
			<div class="col-md-8">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="<?php echo e(URL('/itExecutive/system/update/'.'6')); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="box-body">
								...
								<input type="hidden" class="system_id" value="<?php echo e($system->master_system_id); ?>">
							...
							<div class="box-footer">
								...
								<a href="<?php echo e(URL('/itExecutive/assets/all_system')); ?>" target="_blank" class="btn btn-default">Cancel</a>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo e(getAssetById($system_asset->asset_id,$system_asset->asset_type_id)->name); ?>(<?php echo e(getAssetById($system_asset->asset_id,$system_asset->asset_type_id)->asset_code); ?>)</td>

										<td><a class="btn btn-success" href="<?php echo e(URL('/itExecutive/release-system-asset/'.$system_asset->system_id.'/'.$system_asset->id.'/'.$system_asset->asset_type_id.'/'.$system_asset->master_asset_id)); ?>">Release</a></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#asset_type1").on('change',function(e){
			...
			url = "<?php echo e(URL('itExecutive/getAssetByAssetType_unique/')); ?>";
		...
		$("#assignAssetBtn").on('click',function(e){
			...
			if(asset_type1 == ""){
				...
				url = "<?php echo e(URL('itExecutive/assignAsset_i_mac/')); ?>";
				var data = "<?php echo e($system->system_id); ?>";
