			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading clearfix">
						<a href="<?php echo e(URL('/admin/export/asset-sheet-router')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
							...
							<table class="table"  id="datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td><a class="btn btn-primary" href="<?php echo e(URL('/admin/router/'.$asset->id)); ?>">Edit</a></td>
