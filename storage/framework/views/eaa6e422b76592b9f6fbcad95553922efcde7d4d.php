	...
	<div id="main-wrapper">
		...
		<div class="row" id="dashboard">
			...
			<div class="col-lg-3 col-md-6">
				...
				<a href="<?php echo e(URL('/hrManager/employees?type=active')); ?>" title="" class="weight-hover">
					...
					<div class="panel info-box panel-white">
						...
						<div class="panel-body">
							...
							<div class="info-box-stats">
                                ...
                                <span class="white"><?php echo e(count($employees)); ?></span>
							</div>
						...
						<div class="panel-body">
							...
							<div class="info-box-stats">
								...
								<span class="info-box-title">Leave Requests</span>
                                 <span class="white" ><?php echo e(count($leaves)); ?></span>
							</div>
						...
						<div class="panel-body">
							...
							<div class="info-box-stats">
								...
								<span class="info-box-title">Profile Update Requests</span>
								 <span class="white" ><?php echo e(count($profile_requests)); ?></span>
