	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo e(URL('/employee/projects')); ?>">Projects</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<?php echo e(URL('/teamLead/project/update')); ?>" method="post" enctype="multipart/form-data">
							<div class="box-body">
							...
							<div class="box-footer">
								<a href="<?php echo e(URL('/teanLead/projects')); ?>" class="btn btn-default">Cancel</a>
