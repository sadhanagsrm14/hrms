				...
				<div class="row">
					<div class="col-md-3 center">
						<div class="login-box">
							...
							<form class="m-t-md" action="<?php echo e(URL('/reset-password')); ?>" method="post">
								<?php echo e(csrf_field()); ?>

								<div class="form-group">
									<input type="password" name="new_password"  class="form-control" placeholder="New Password">
									<?php if($errors->has('new_password')): ?>
									<span class="label label-danger"><?php echo e($errors->first('new_password')); ?></span>
									<?php endif; ?>
								</div>
								<div class="form-group">
									<input type="password" name="confirm_password"  class="form-control" placeholder="Confirm Password">
									<?php if($errors->has('confirm_password')): ?>
									<span class="label label-danger"><?php echo e($errors->first('confirm_password')); ?></span>
									<?php endif; ?>
								</div>
