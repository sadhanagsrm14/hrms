							...
							<table class="table" id="datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="<?php echo e(URL('/teamLead/project/'.$project->id)); ?>"><?php echo e(getProjectById($project->id)->name); ?></a></td>
											<td><?php echo e(getUserById($project->user_id)['first_name']); ?></td>
												<td><?php echo e(getUserById($project->reporting_to)['first_name']); ?> <?php echo e(getUserById($project->reporting_to)['last_name']); ?></td>
										...
										<td><?php if($project->project_status == -1): ?>
											...
											<?php endif; ?></td>
										<td>
											<a href="<?php echo e(URL('/teamLead/project/'.$project->id)); ?>" class="btn btn-primary">View</a>
