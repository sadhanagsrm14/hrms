	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="active"><a href="<?php echo e(URL('/itExecutive/systems')); ?>">System</a></li>
			</ol>
		</div>
	</div>
	<div id="main-wrapper">
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading clearfix">
						<a href="<?php echo e(URL('/itExecutive/export/system-sheet')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Systems</a>
					</div>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo e(URL('/itExecutive/employee/'.$system->assign_to)); ?>"><?php echo e(getUserById($system->assign_to)->first_name); ?></a></td>
											<?php else: ?>
											<b>N/A</b>
											<?php endif; ?>
										</td>
										...
										<td>
											...
											<a class="btn btn-primary" href="<?php echo e(URL('/itExecutive/system/'.$system->id)); ?>">Edit</a>
										</td>
