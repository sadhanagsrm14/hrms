			...
			<div class="col-md-8">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" action="<?php echo e(URL('/admin/system/update/'.'5')); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="box-footer">
								...
								<a href="<?php echo e(URL('/admin/systems')); ?>"  class="btn btn-default">Cancel</a>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><a class="btn btn-success" href="<?php echo e(URL('/admin/release-system-asset/'.$system_asset->system_id.'/'.$system_asset->id.'/'.$system_asset->asset_type_id.'/'.$system_asset->master_asset_id)); ?>">Release</a></td>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#asset_type1").on('change',function(e){
			...
			url = "<?php echo e(URL('admin/getAssetByAssetType_unique/')); ?>";
		...
		$("#asset").on('change',function(e){
			...
			url = "<?php echo e(URL('admin/free_assets/')); ?>";
		...
		$("#assignAssetBtn").on('click',function(e){
			...
			if(asset_type1 == ""){
				...
				url = "<?php echo e(URL('admin/assignAsset_mac_mini/')); ?>";
