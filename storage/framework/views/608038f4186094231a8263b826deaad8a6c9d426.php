										...
										<div class="tab-pane active fade in" id="tab1">
											<div class="row m-b-lg">
												...
												<div class="form-group  col-md-6">
													...
													<input type="text" class="datepicker form-control col-md-6" name="dob" id="dob"  value="<?php echo e($employee->personal_profile->dob); ?>" placeholder="Date Of Birth" >
												</div>
												<div class="form-group  col-md-6">
													<label for="anniversary_date">Anniversary</label>
													<input type="text" class="datepicker form-control col-md-6" name="anniversary_date" id="anniversary_date"  value="<?php echo e($employee->personal_profile->anniversary_date); ?>" placeholder="Anniversary" >
												</div>
