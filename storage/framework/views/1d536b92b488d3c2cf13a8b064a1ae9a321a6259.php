	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><a href="<?php echo e(URL('/itExecutive/assets')); ?>">Asset</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<a href="<?php echo e(URL('/itExecutive/export/asset-sheet')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo e(URL('/itExecutive/system/'.$asset->system_id)); ?>"><?php echo e(getSystemById($asset->system_id)['name']); ?> <?php echo e(getSystemById($asset->system_id)['system_id']); ?></a></td>
										...
										<td><?php echo e($asset->descriptions); ?></td>

										<td><?php echo e($asset->status); ?></td>

										<td><a class="btn btn-primary" href="<?php echo e(URL('/itExecutive/asset/'.$asset->id)); ?>">Edit</a></td>
...
<script>
	...
	function releaseAsset(asset_id){
		...
		var url = "<?php echo e(URL('itExecutive/assetRelease/')); ?>";
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "<?php echo e(URL('/itExecutive/import/asset-sheet')); ?>";
