            ...
            <tr>
                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="70" valign="top" class="header-cell">
                    <img width="196" height="60" src="<?php echo e(URL('/images/cb-logo.png')); ?>" alt="logo" style="margin:15px;">
                  </td>
                  <td height="70" valign="top" style="background: #0d85eef2;
                  padding: 15px;
                  text-align: right;
                  color: #fff" >
                  <b>Date:</b><?php echo e($resign->date_of_resign); ?>
                ...
                <td>
                  <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" BORDER="0" BORDERCOLORLIGHT="#C7F25F" >
                    ...
                    <tbody style="background-color:#fff;">
                      <tr>
                        <td style="width:100%; text-align:left;"><?php echo e($resign->message); ?></td>
              ...
              <tr>
                <td style="padding-top:20px; background-color:#ffffff;">
                 ...
                 ( <?php echo e(getRoleById($user->role)); ?> )<br/>
