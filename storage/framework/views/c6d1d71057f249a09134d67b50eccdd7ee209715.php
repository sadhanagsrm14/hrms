	...
	<div id="main-wrapper">
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<?php $hrManager_id= Auth::user()->cb_profile->employee_id; ?>
								...
								<tbody>
									...
									<tr>
										...
										if($j == 1 && $day_name == 'Sun'){
											...
											<td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
											...
											<td></td><td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
											...
											<?php }elseif( $j == 1 && $day_name == 'Tue'){
												...
												<td></td><td></td><td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
												...
												<?php }elseif( $j == 1 && $day_name == 'Wed'){
													...
													<td></td><td></td><td></td><td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
													...
													<?php }elseif( $j == 1 && $day_name == 'Thu'){
														...
														<td></td><td></td><td></td><td></td><td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
														...
														<?php }elseif( $j == 1 && $day_name == 'Fri'){
															...
															<td></td><td></td><td></td><td></td><td></td><td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
															...
															<?php }elseif( $j == 1 && $day_name == 'Sat'){
																...
																<td></td><td></td><td></td><td></td><td></td><td></td><td class="<?php echo e(getAttendanceBydate($cdate,$hrManager_id)); ?>"><?php echo e($j); ?></td>
							...
							<script>
								...
								$(document).ready(function() {
									...
									$('#filterCalender').on('click',function(event) {
										...
										var url = "<?php echo e(URL('/hrManager/holiday-calender')); ?>";
