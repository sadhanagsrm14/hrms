...
<head>
  ...
  <body class="page-header-fixed">
    ...
    <main class="page-content content-wrap">
      ...
      <div class="navbar">
        ...
        <div class="navbar-inner">
          ...
          <div class="logo-box">
            ...
            <a href="<?php echo e(URL('/')); ?>" class="logo-text"><span>CB-HRMS</span></a>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu title-caret dropdown-lg" role="menu">
                    ...
                    <li class="drop-all"><a href="<?php echo e(URL('/hrManager/view-notification')); ?>" class="text-center">All Notification</a></li>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-list" role="menu">
                    ...
                    <li role="presentation"><a href="<?php echo e(URL('/hrManager/holiday-calender')); ?>"><i class="fa fa-calendar"></i>Holiday Calendar</a></li>
        ...
        <?php echo $__env->make('hrManager.layouts.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
      ...
      <?php echo $__env->make('hrManager.layouts.footer_navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
