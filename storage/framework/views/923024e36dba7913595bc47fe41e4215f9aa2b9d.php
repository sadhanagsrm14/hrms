        ...
        <center>
                ...
                <table cellpadding="0" cellspacing="0" class="force-full-width">
                  <tr>
                   <td height="70" valign="top" class="header-cell">
                    <img width="196" height="60" src="<?php echo e(URL('/images/logo.png')); ?>" alt="logo" style="margin:15px;">
                  </td>
                  <td height="70" valign="top" style="background: #0d85eef2;
                  padding: 15px;
                  text-align: right;
                  color: #fff" >
                  <b>Date:</b><?php echo e($date_of_eod); ?>
              ...
              <tr>
                      ...
                      <table cellspacing="1" cellpadding="1" width="100%" bgcolor="#ffffff" BORDER="1" BORDERCOLORLIGHT="#C7F25F" >
                        <thead align="left" style="background-color:#0f81e4; color:#fff; text-align:center;">
                          <tr>
                            ...
                            <th style="width:29%;">Decription</th>
                            <th style="width:25%;">Comment</th>
                            <th style="width:6%;">Hour</th>
                          </tr>
                        </thead>
                        <tbody style="background-color:#1c87e41f;">
                         ...
                         <tr>
                          <td style="width:20%; text-align: center;"><?php echo e(getProjectById($eod->project_id)->name); ?></td>
                          <td style="width:29%; text-align: center;"><?php echo e($eod->task); ?></td>
                          <td style="width:25%; text-align: center;"><?php echo e($eod->comment); ?></td>
                          <td style="width:6%; text-align: center;"><?php echo e($eod->hours_spent); ?></td>
                        </tr>
                ...
                <tr>
                  <td style="padding-top:20px; background-color:#ffffff;">
                   ...
                   ( <?php echo e($user->cb_profile->designation); ?> )<br/>
         ...
         <tr>
          <td valign="top" class="footer-cell" colspan="2">
            © <?php echo e(date('Y')); ?> Coding Brains. All Rights Reserved.
          </td>
        </tr>
      </table>
    </td>
