	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo e(URL('/itExecutive/assets/all_assets')); ?>">Asset</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(URL('/itExecutive/monitor/update')); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select class="form-control select2" name="system_type_id" id="system_type_id" style="width: 100%;">
											...
											<?php $__currentLoopData = $system_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $system_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

											<option value="<?php echo e($system_type->id); ?>"><?php echo e($system_type->name); ?> </option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select class="form-control select2" name="system_id" id="system_id" style="width: 100%;">
                                            <?php if($asset->system_code): ?>
                                            <option value="<?php echo e($asset->system_id); ?>"><?php echo e($asset->system_code); ?></option>
                                            <?php else: ?>
							...
							<div class="box-footer">
								...
								<a href="<?php echo e(URL('/itExecutive/assets/all_assets')); ?>" class="btn btn-default">Cancel</a>
	...
	$(document).ready(function() {
		...
		$('#system_type_id').change(function(){
           var system_type_id =  $('#system_type_id').val();
            ...
            url = "<?php echo e(URL('itExecutive/systemBySystemType/')); ?>";
