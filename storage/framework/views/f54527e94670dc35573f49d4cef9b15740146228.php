			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<?php echo e(URL('/admin/leave-type/update')); ?>" method="post" enctype="multipart/form-data">
							<div class="box-body">
								<?php echo e(csrf_field()); ?>

								<input type="hidden" name="id" value="<?php echo e($leave_type->id); ?>">
								<div class="form-group">
									<label for="leave_type" class="col-sm-2 control-label">Leave Type</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" name="leave_type" value="<?php echo e($leave_type->leave_type); ?>" placeholder="Leave type">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea name="description" id="description" cols="30" rows="10" class="form-control"  placeholder="Leave Type Description"><?php echo e($leave_type->description); ?></textarea>
							...
							<div class="box-footer">
								<a href="<?php echo e(URL('/admin/leave-types')); ?>" class="btn btn-default">Cancel</a>
