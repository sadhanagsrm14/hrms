							...
							<div class="col-md-12">
								<div class="row">
									...
									<div class="form-group  col-md-6">
										...
										<input type="text" class="pastDatepicker form-control col-md-6" name="dob" id="dob"  value="<?php echo e($profile->dob); ?>" placeholder="Date Of Birth" >
									</div>
									<div class="form-group  col-md-6">
										<label for="anniversary_date">Anniversary</label>
										<input type="text" class="pastDatepicker form-control col-md-6" name="anniversary_date" id="anniversary_date"  value="<?php echo e($profile->anniversary_date); ?>" placeholder="Anniversary" >
									</div>
