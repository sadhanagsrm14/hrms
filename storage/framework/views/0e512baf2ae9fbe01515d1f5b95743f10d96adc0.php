			...
			<div class="col-md-12">	
				<div class="panel panel-white">					
					...
					<div class="panel-body">
						...
						<div class="col-md-8">
							<a  class="btn btn-success pull-right UpdateAttendance" style="margin-top: -16px;" data-mydate="<?php echo e(date('Y-m-d')); ?>">Review Today's Attendance</a>
								...
								<tr>
									...
									<tr>									
										...
										<tr>
											...
											<td ></td>
											<?php else: ?>
											<td><a class="btn btn-reponsive btn-primary UpdateAttendance" data-mydate="<?php echo e($date); ?>" >Edit</a></td>
											<?php endif; ?>
											<?php endfor; ?>
										</tr>
									</table> 
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('.UpdateAttendance').click(function(){
					...
					var mdata = {"muydate":mydate,"_token":token};
