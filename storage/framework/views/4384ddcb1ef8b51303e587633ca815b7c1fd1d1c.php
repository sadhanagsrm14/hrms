							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<?php if($leave->is_approved == 1 && $leave->date_from >= date('m/d/Y') ): ?>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(url('/employee/retract/leave/'.$leave->id)); ?>" enctype="multipart/form-data" id="resignForm<?php echo e($leave->id); ?>">
