      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(url('/itExecutive/retract/leave/'.$leave->id)); ?>" enctype="multipart/form-data" id="resignForm<?php echo e($leave->id); ?>">
