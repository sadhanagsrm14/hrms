	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo e(URL('/admin/eods')); ?>">All EODs</a></li>
						...
						<form class="form-horizontal" method="post" enctype="multipart/form-data">
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea name="comments" readonly="readonly" id="comments" cols="30" rows="10" class="form-control">
							...
							<div class="box-footer">
								<a href="<?php echo e(URL('/admin/eods')); ?>" class="btn btn-default">Back</a>
							</div>
							<!-- /.box-footer -->
						</form>
					</div>
