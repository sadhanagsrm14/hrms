	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><a href="<?php echo e(URL('/itExecutive/assets/all_system')); ?>">System</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<a href="<?php echo e(URL('/itExecutive/export_desktop/system-sheet')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Systems</a>
						...
						<div class="table-responsive table-remove-padding">
							...
							<table class="table" id="datatable">
								...
								<tbody>
									...
									<tr>
                                        <td style="display:none;"><?php echo e($system->id); ?></td>
										...
										<td>
											...
											<a class="btn btn-primary" href="<?php echo e(URL('/itExecutive/system/'.$system->id.'/'.$system->master_system_id)); ?>">Edit</a>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			$.ajax({
				url: "<?php echo e(route('it.uploadsystem')); ?>",
				type: 'POST',
				data: form_data,
	...
	function assignsystem(){
		...
		url = "<?php echo e(URL('itExecutive/assignsystem/')); ?>";
	...
	function releasesystem(system_id){
		...
		var url = "<?php echo e(URL('itExecutive/systemRelease/')); ?>";
	...
	$('#uploadsystem').on('click',function(){
		...
		if(systemFile.files[0]) {
			...
			var url  = "<?php echo e(URL('/itExecutive/import/system-sheet')); ?>";
