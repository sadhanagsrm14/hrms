	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			...
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo e(URL('/hrManager/employees')); ?>">Employees</a></li>
					...
					<div class="panel-body">
						...
						<div id="rootwizard">
							...
							<!-- <form id="wizardForm"> -->
								...
								<form class="form-horizontal" method="post" action="<?php echo e(URL('/hrManager/employee/update')); ?>" enctype="multipart/form-data" id="employeeForm">
												...
												<div class="col-md-10">
													...
													<div class="row">
														...
														<div class="form-group col-md-12">
															...
															<label for="emp_status">Employee Working Status</label>

															<select name="emp_status" id="emp_status" class="form-control">
																<?php $__currentLoopData = $employee_status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<?php if($status->id == $employee->is_active): ?>
