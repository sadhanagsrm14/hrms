								...
								<div class="panel-body">
									...
									<div class="info-box-stats">
										...
										<span class="info-box-title">Last Working Day <br>
                                           <?php if(\Auth::user()->cb_profile->notice_period): ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="reporting_manager" id="reporting_manager" class="form-control select2">
											...
											<option value="<?php echo e($reporting_manager->reporting_to); ?>"><?php echo e(getUserById($reporting_manager->reporting_to)->first_name); ?> <?php echo e(getUserById($reporting_manager->reporting_to)->last_name); ?></option>
