			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(URL('/admin/cabinet/update')); ?>" enctype="multipart/form-data">
	...
	$(document).ready(function() {
		...
		$('#system_type_id').change(function(){
           ...
           var asset_type_id =  $('#asset').val(); 
            ...
            url = "<?php echo e(URL('admin/systemBySystemType/')); ?>";
