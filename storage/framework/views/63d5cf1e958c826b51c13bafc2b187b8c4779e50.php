			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading clearfix">
						<a href="<?php echo e(URL('/admin/export/asset-sheet-keyboard')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
							...
							<table class="table"  id="datatable">
								...
								<tbody>
									...
									<tr>
										...
										<td><b><?php echo e(is_null($asset->system_code)?"N/A":$asset->system_code); ?></b></td>
										<td><?php echo e($asset->status); ?></td>
										<td><a class="btn btn-primary" href="<?php echo e(URL('/admin/keyboard/'.$asset->id)); ?>">Edit</a></td>
										<td><?php echo e(getUserById($asset->last_editing_by)->first_name); ?> <?php echo e(getUserById($asset->last_editing_by)->last_name); ?></td>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "<?php echo e(URL('/admin/import_keyboard/asset-sheet')); ?>";
			$.ajax({
				url: url,
				type: 'POST',
				data: form_data,
