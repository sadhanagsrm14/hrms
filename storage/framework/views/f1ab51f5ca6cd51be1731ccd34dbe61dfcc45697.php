			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						<form class="form-horizontal" action="<?php echo e(URL('/teamLead/employee-project/update')); ?>" method="post" enctype="multipart/form-data">
							<div class="box-body">
								<?php echo e(csrf_field()); ?>

								<input type="hidden" name="id" value="<?php echo e($employee_project->id); ?>">
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="project" id="project" class="form-control select2">
											...
											<option value="<?php echo e($project->id); ?>" <?php echo e($project->id == $employee_project->project_id ? "selected":''); ?>><?php echo e($project->name); ?></option>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="assign_to" id="assign_to" class="form-control select2">
											...
											<option value="<?php echo e($employee->id); ?>" <?php echo e($employee->id == $employee_project->user_id ? "selected":''); ?>><?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>	
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="reporting_to" id="reporting_to" class="form-control select2">
											...
											<option value="<?php echo e($upperEmployee->id); ?>" <?php echo e($upperEmployee->id == $employee_project->reporting_to ? "selected":''); ?>><?php echo e($upperEmployee->first_name); ?> <?php echo e($upperEmployee->last_name); ?></option>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</select>	
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="datepicker form-control" name="from_date" value="<?php echo e($employee_project->from_date); ?>" placeholder="From Date">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="datepicker form-control" name="end_date" value="<?php echo e($employee_project->end_date); ?>" placeholder="Project End Date">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<select name="project_status" id="project_status" class="form-control">
											<option value="-1" <?php echo e(-1 == $employee_project->project_status ? "selected":''); ?>>Not Started</option>
											<option value="0" <?php echo e(0 == $employee_project->project_status ? "selected":''); ?>>In Progress</option>
											<option value="1" <?php echo e(1 == $employee_project->project_status ? "selected":''); ?>>Completed</option>
										</select>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<textarea name="feedback" id="feedback" cols="30" rows="10" class="form-control"><?php echo e($employee_project->feedback); ?></textarea>
							...
							<div class="box-footer">
								<a href="<?php echo e(URL('/teamLead/assign-project')); ?>" class="btn btn-default">Cancel</a>
