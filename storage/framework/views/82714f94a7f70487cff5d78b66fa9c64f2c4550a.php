...
<meta http-equiv="expires" content="0">
	...
	<body class="page-header-fixed">
		...
		<main class="page-content content-wrap">
			...
			<div class="navbar">
				...
				<div class="navbar-inner">
					...
					<div class="logo-box">
						...
						<a href="<?php echo e(URL('/employee/dashboard')); ?>" class="logo-text"><span>CB-HRMS</span></a>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu title-caret dropdown-lg" role="menu">
										...
										<li class="drop-all"><a href="<?php echo e(URL('/employee/view-notification')); ?>" class="text-center">All Notification</a></li>
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu dropdown-list" role="menu">
										...
										<li role="presentation"><a href="<?php echo e(URL('/employee/holiday-calender')); ?>"><i class="fa fa-calendar"></i>Holiday Calendar</a></li>
			...
			<?php echo $__env->make('employee.layouts.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<?php echo $__env->make('employee.layouts.footer_navbar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		...
		<?php if(!isAttendanceDone($mydate,$employee_id) && date('H') >= 12 && date('H') <= 24): ?>	
		...
		<script type="text/javascript">
			...
			swal({
				...
				var url = "/employee/addAttendance";
