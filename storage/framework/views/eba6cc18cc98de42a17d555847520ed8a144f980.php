	...
	<div class="page-title">
		...
		<div class="page-breadcrumb">
			<ol class="breadcrumb">
				...
				<li><a href="<?php echo e(URL('itExecutive/assets/all_assets')); ?>">All Assets</a></li>
			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					<div class="panel-heading clearfix">
						<a href="<?php echo e(URL('/itExecutive/export/asset-sheet-network_switch')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
						...
						<div class="table-responsive table-remove-padding">
							<table class="table"  id="datatable">
								...
								<tbody>
									...
									<tr>
										<td style="display:none;"><?php echo e($asset->id); ?></td>
										...
										<td><?php echo e(is_null($asset->system_code)? "N/A" :$asset->system_code); ?></td>
										<td><?php echo e($asset->status); ?></td>
										<td><a class="btn btn-primary" href="<?php echo e(URL('/itExecutive/network_switch/'.$asset->id)); ?>">Edit</a></td>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "<?php echo e(URL('/itExecutive/import_network_switch/asset-sheet')); ?>";
			$.ajax({
				url: url,
				type: 'POST',
				data: form_data,
