   ...
   <div id="main-wrapper">
      <div class="row">
         <div class="col-md-12">
            ...
            <div class="alert alert-success">					<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>					<?php echo e(session('success')); ?>				</div>
            <?php endif; ?>				<?php if(session('error')): ?>				
            <div class="alert alert-danger">					<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>					<?php echo e(session('error')); ?>				</div>
            <?php endif; ?>				
            <div class="panel panel-white">
               ...
               <div class="panel-body">
                  <form class="form-horizontal" action="<?php echo e(URL('/admin/project/update')); ?>" method="post" enctype="multipart/form-data">
                     <div class="box-body">
                        <?php echo e(csrf_field()); ?>								<input type="hidden" name="id" value="<?php echo e($project->id); ?>">								
                        <div class="form-group">
                           <label for="project_name" class="col-sm-2 control-label">Project Name</label>									
                           <div class="col-sm-10">										<input type="text" class="form-control" name="project_name" value="<?php echo e($project->name); ?>" placeholder="Project Name">										<?php if($errors->has('project_name')): ?>										<span class="label label-danger"><?php echo e($errors->first('project_name')); ?></span>										<?php endif; ?>									</div>
                        </div>
                        <div class="form-group">
                           <label for="start_date" class="col-sm-2 control-label">Start Date</label>									
                           <div class="col-sm-10">										
                           	 <input type="text" class="datepicker form-control" id="start_date" name="start_date" value="<?php echo e($project->start_date); ?>" placeholder="Project Start Date">										
                        ...
                        <div class="form-group">
                           ...
                           <div class="col-sm-10">										
                           	<input type="text" class="datepicker  form-control" name="end_date" id="end_date" value="<?php echo e($project->end_date); ?>" placeholder="Project End Date">	
                           	<?php if($errors->has('end_date')): ?>										
                           	<span class="label label-danger"><?php echo e($errors->first('end_date')); ?></span>								<?php endif; ?>									
                           </div>
                        </div>
                        <div class="form-group">
                           <label for="client_name" class="col-sm-2 control-label">Client Name</label>									
                           <div class="col-sm-10">										<input type="text" class="form-control" name="client_name" value="<?php echo e($project->client_name); ?>" placeholder="Client Name">										<?php if($errors->has('client_name')): ?>										<span class="label label-danger"><?php echo e($errors->first('client_name')); ?></span>										<?php endif; ?>									</div>
                        </div>
                        <div class="form-group">
                           <label for="project_comments" class="col-sm-2 control-label">Comments</label>									
                           <div class="col-sm-10">										
                           	<textarea name="project_comments" id="project_comments" cols="30" rows="10" class="form-control" placeholder="Project Comments"><?php echo e($project->project_comments); ?>
