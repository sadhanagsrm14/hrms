			...
			<div class="col-md-12">
				...
				<div class="panel panel-white info-box-re">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(url('/itExecutive/retract/')); ?>" enctype="multipart/form-data" id="resignForm">
							...
							<div class="modal-footer">
											...
											<a href="<?php echo e(url('/resign')); ?>" class="btn btn-default" data-dismiss="modal" onclick="window.location.reload()">Cancel</a>
