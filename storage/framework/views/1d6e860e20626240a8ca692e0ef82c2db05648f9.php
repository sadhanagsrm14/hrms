               ...
               <!--  <li>  
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu title-caret dropdown-lg" role="menu">
                    <li><p class="drop-title">You have <span id="unreadMsg"><?php echo e(getUnreadNotificationsById(\Auth::user()->id)); ?></span> notification !  <span class="badge badge-roundless badge-danger pull-right">Mark all as read</span></p></li>
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle waves-effect waves-button waves-classic" data-toggle="dropdown">
                    ...
                    <img class="img-circle avatar" src="http://hrms.projects-codingbrains.com/images/employees/default-user.png" width="40" height="40" alt="">
                  </a>
