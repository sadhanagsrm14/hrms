			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-body">
						...
						<form class="form-horizontal" method="post" action="<?php echo e(URL('/itExecutive/mouse/update')); ?>" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="asset" id="asset" class="form-control "   >
											...
											<option class="nsns" value="<?php echo e($asset->asset_id); ?>"><?php echo e($asset->asset->name); ?></option>
