		...
		<div class="row">
			...
			<div class="col-md-3 profile-image">
				<div class="profile-image-container">
					<a href="javascript:void(0)" class="btn btn-success profile-pic"  data-toggle="modal" data-target="#uploadProfilePicModal" title="Upload Profile Image"><i class="fa fa-camera 2x"></i></a>
