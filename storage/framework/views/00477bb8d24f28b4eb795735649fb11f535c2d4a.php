			...
			<div class="col-md-12">
				...
				<div class="panel panel-white">
					...
					<div class="panel-heading clearfix">
						...
						<a href="<?php echo e(URL('/admin/export/asset-sheet')); ?>" class="btn btn-danger pull-right" style="margin-top: -16px;margin-right: 10px;">Export Assets</a>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo e(URL('/admin/system/'.$asset->system_id)); ?>"><?php echo e(getSystemById($asset->system_id)['name']); ?> <?php echo e(getSystemById($asset->system_id)['system_id']); ?></a></td>
										...
										<td><a class="btn btn-primary" href="<?php echo e(URL('/admin/asset/'.$asset->id)); ?>">Edit</a></td>
										<td><?php echo e(getUserById($asset->last_editing_by)['first_name']); ?></a></td>
...
<script>
	...
	$('#uploadAsset').on('click',function(){
		...
		if(assetFile.files[0]) {
			...
			var url  = "<?php echo e(URL('/admin/import/asset-sheet')); ?>";
