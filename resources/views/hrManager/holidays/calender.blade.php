								...
								<tbody>
									...
									<tr>
										...
										if($j == 1 && $day_name == 'Sun'){
											...
											<td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
											...
											<td></td><td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
											...
											<?php }elseif( $j == 1 && $day_name == 'Tue'){
												...
												<td></td><td></td><td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
												...
												<?php }elseif( $j == 1 && $day_name == 'Wed'){
													...
													<td></td><td></td><td></td><td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
													...
													<?php }elseif( $j == 1 && $day_name == 'Thu'){
														...
														<td></td><td></td><td></td><td></td><td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
														...
														<?php }elseif( $j == 1 && $day_name == 'Fri'){
															...
															<td></td><td></td><td></td><td></td><td></td><td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
															...
															<?php }elseif( $j == 1 && $day_name == 'Sat'){
																...
																<td></td><td></td><td></td><td></td><td></td><td></td><td class="{{getAttendanceBydate($cdate,$hrManager_id)}}">{{$j}}</td>
							...
							<script>
								...
								$(document).ready(function() {
									...
									$('#filterCalender').on('click',function(event) {
										...
										var url = "{{URL('/hrManager/holiday-calender')}}";
