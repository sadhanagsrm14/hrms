								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<select name="reporting_manager" id="reporting_manager" class="form-control select2">
											...
											<option value="{{$reporting_manager->team_leader_id}}">{{getUserById($reporting_manager->team_leader_id)->first_name}} {{getUserById($reporting_manager->team_leader_id)->last_name}}</option>
