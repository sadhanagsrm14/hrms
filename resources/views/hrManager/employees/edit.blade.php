					...
					<div class="panel-body">
						...
						<div id="rootwizard">
							...
							<!-- <form id="wizardForm"> -->
								...
								<form class="form-horizontal" method="post" action="{{URL('/hrManager/employee/update')}}" enctype="multipart/form-data" id="employeeForm">
														...
														<div class="form-group col-md-12">
															...
															<select name="emp_status" id="emp_status" class="form-control">
																@foreach($employee_status as $status)
																	@if($status->id == $employee->is_active)
